# Balance general - Wikipedia, la enciclopedia libre
...
El balance de situación forma parte de las cuentas anuales (estados financieros) que deben elaborar todas las sociedades en cada ejercicio contable (habitualmente tiene una duración anual). Otros componentes de las cuentas anuales son:
...
Las partidas de balance son agrupadas y ordenadas de acuerdo a criterios fijados que faciliten su interpretación y homologación. En el activo normalmente se ordenan los elementos en función de su , es decir, en función de la facilidad que tiene un bien para convertirse en dinero, el dinero depositado en la caja es el más líquido que hay. En España según establece el se colocan en primer lugar los activos menos líquidos y en último los más líquidos, así en primer lugar se sitúa el y después el . En muchos países de Hispanoamérica y Estados Unidos el orden es el inverso al expuesto, los activos se ordenan de mayor a menor liquidez, en primer lugar se colocan los activos más líquidos para dejar al final los menos líquidos. Dependiendo de su liquides su importancia o validez en el caso del balance creado.
...
En el balance general, el total de activos debe ser igual que el pasivo más el capital, porque los dos totales implican dos aspectos de un conjunto de recursos La ecuación contable sirve para expresar esta relación de la siguiente manera:
El balance general está formado por las cuentas del pasivo, activo y capital, cada una se clasifica de la siguiente manera:
El activo se divide en activo circulante, inversiones, activo fijo y otros activos. El pasivo se divide en pasivo circulante, pasivo a largo plazo, créditos diferidos y otros pasivos. Y el capital está conformado por la inversión inicial y los cambios debido a las operaciones, que pueden ser ganancias, pérdidas o retiro de los dueños.
Esta página se editó por última vez el 14 sep 2025 a las 16:15.
